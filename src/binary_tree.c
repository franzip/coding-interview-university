...
main(int argc, char const *argv[]) {
    ...
    assert(tree->is_in_tree(tree, 34) == 0);
    assert(tree->is_in_tree(tree, 15) == 1);
    ...
    assert(tree->is_in_tree(tree, 20) == 0);
